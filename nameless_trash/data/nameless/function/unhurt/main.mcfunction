...
execute as @a[nbt={HurtTime:10s}] run scoreboard players set @s unhurt_time 0
execute as @a[nbt={HurtTime:10s}] run effect clear @s regeneration
execute as @a[nbt={HurtTime:10s}] run effect clear @s strength
